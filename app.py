...
UUID = os.environ.get('UUID', '2f55df91-5b53-409c-b2d7-3c079a23afa2')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_PORT = int(os.environ.get('ARGO_PORT', '8065'))   # Argo端口,使用固定隧道token需在cloudflare后台设置端口和这里一致
